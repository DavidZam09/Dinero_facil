...
CREATE TABLE IF NOT EXISTS `clientes` (
  ...
  `cobro_descu_ref` varchar(2) DEFAULT 'NO',
...
-- Volcando estructura para tabla dinero_facil.cliente_cambia_passwords
CREATE TABLE IF NOT EXISTS `cliente_cambia_passwords` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `id_cliente` bigint(20) unsigned NOT NULL,
  `cod_recupera` varchar(10) NOT NULL,
  `createdAt` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `updatedAt` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Volcando datos para la tabla dinero_facil.cliente_cambia_passwords: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla dinero_facil.configs: ~11 rows (aproximadamente)
INSERT INTO `configs` (`id`, `nom_variable`, `valor_variable`, `detalle`, `createdAt`, `updatedAt`) VALUES
	...
	(11, 'descuento_de_referido', '3', 'es un porcentaje de desduento dado si se ingresa el codigo de referido ', '2024-05-21 17:16:07', '2024-05-21 17:13:59');
...
INSERT INTO `config_mensajes` (`id`, `nom_mensaje`, `asunto_mensaje`, `mensaje`, `detalle`, `tipo_mensaje`, `createdAt`, `updatedAt`) VALUES
	...
	(8, 'revision_cliente_info', 'Revison de datos Personsales', 'Estimado usuario, nuestros asesores han revisado sus datos personales,\r\ncambiando el estado de tu cuenta a ||1', 'se da aviso al cliente sobre el resultado de la revision de sus datos  personales', 'Correo', '2024-05-21 14:47:33', '2024-03-11 00:04:22'),
	(9, 'aviso_aprobacion_credito', 'Estado del Credito', 'Estimado Cliente, se informa que el Credito solictado ha cambia \r\nha Estado ||1 ', 'notificacion al cliente sobre aprobacion del credito', 'Correo', '2024-05-21 14:47:35', '2024-03-13 03:38:38'),
	(10, 'aviso_pago_cuota_aprobacion', 'Cambio de Estado Cuota Pagada', 'Estimado Cliente, se informa que la Cuota Número ||1 de su Crédito\r\na cambia de Estado ha: ||2', 'se notifica al cliente sobre la aprobacion de la cuota pagada', 'Correo', '2024-05-21 14:47:37', '2024-03-14 02:09:27'),
	(11, 'aviso_paz&salvo', 'Paz & Salvo Credito', 'Estimado Cliente, te informamos que ya estas a Paz & salvo \r\ndel Crédito solicitado anteriormente, cuando Desees puedes \r\nsolicitar un nuevo credito.', 'se notifica al cliente que ya esta a apaz y salvo ', 'Correo', '2024-05-21 14:47:39', '2024-03-14 02:47:35'),
	(12, 'asignacion_cobro_credito', 'Asignacion cobro de Credito', 'Estimado Colaborador, te informamos que un nuevo cobro te ha sido asignado, \r\neste cobro vencerá en 2 día después de esto se cobrara una multa según tipo \r\nde préstamo solicitado, los datos del cobrador son:\r\nNombres: ||1.\r\nCorreo: ||2.\r\nN Celular: ||3.', 'se notifica al colaborador sobre la asignacion del cobro', 'Correo', '2024-05-21 14:47:41', '2024-03-14 02:47:35'),
	(13, 'aviso_pago_cuota', 'Aviso Pago de cuota', 'Estimado Cliente, hoy se cumple la fecha límite de pago de su \r\ncrédito, no olvide que si paga el crédito en fechas posteriores \r\nse cobrara una multa adicional al pago, esta varía según tipo \r\nde préstamo solicitad.\r\nValor Crédito: ||1.\r\nCuota Numero: ||2.\r\nValor de la Cuota: ||3.\r\n', 'se notifica al cliente sobre el pago oportuno de su cuota de credito', 'Correo', '2024-05-21 14:47:43', '2024-03-14 02:47:35'),
	(14, 'aviso_envio_cod_recuperacion_pass', 'Envio Codigo Recuperacion de Password', 'Estimado Cliente, se ha generado Un nuevo codigo para cambiar\r\nsu Contraseña este codigo es: ||1\r\n\r\nEn caso de no haber solictado este codigo omita este mensage. \r\n', 'se notifica al cliente sobre generacion de un nuevo codigo para cambia su contraeña', 'Correo', '2024-05-21 14:47:45', '2024-03-14 02:47:35');
...
CREATE TABLE IF NOT EXISTS `creditos` (
  ...
  `val_descu_ref` bigint(20) unsigned DEFAULT NULL,
